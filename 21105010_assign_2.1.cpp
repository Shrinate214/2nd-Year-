...
void pop(Node*&head){                                                 //Function to POP out last element
    Node*temp=head;
    while(temp->next!=NULL){temp=temp->next;}
    temp->prev->next=NULL;
    delete temp;
...
*********************************************************************************************************/
/*Bonus: Try to find a way to link the family members' doubly-linked list based on their relationship. (Is it possible?)
Answer-One way to solve this would be by sorting/arranging the doubly linked list according to age in decending order.Then we get a linked list in which older generation will be close to head in double linked list and new generation people will be adde close to end of doubly linked list.
*/
